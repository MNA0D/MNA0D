            ...
            <main className="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div className="container-fluid text-center">
                    <div className="row g-4 py-5 row-cols-1 ">
                        <iframe src="http://127.0.0.1:5501/shell.html" width="100%" height="1000" frameborder="0">
                ...
                <div className="container px-4 py-5" id="hanging-icons">
                    ...
                    <div className="row g-4 py-5 row-cols-1 row-cols-lg-4">
                        <div className="d-flex flex-column h-100 p-1 pb-1 features-box">
                            <div className="icon-square bg-light text-dark flex-shrink-0 me-3">
                                <svg className="bi" width="1em" height="1em"><use xlinkHref="#toggles2" /></svg>
                            </div>
                            <div>
                                <h2>Informations à propos de la victime</h2>
                    ...
                    <div className="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-5">
                        ...
                        <div className="col visiualisation">
                            <div className="card card-cover h-100 overflow-hidden text-white bg-dark rounded-5 shadow-lg" style={{ backgroundImage: 'url("/assets/image/unsplash-photo-2.jpg")' }}>
                                <div className="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1">
                                    <a href="#" className="no-line visiualisation-a">
                                        <h2 className="pt-5 mt-5 mb-4 display-6 lh-1 fw-bold">Visualisation de l'écran</h2>
                                        <ul className="d-flex list-unstyled mt-auto">
                                            <li className="me-auto">
                                                <img src="https://github.com/twbs.png" alt="Bootstrap" width="32" height="32" className="rounded-circle border border-white" />
                                            </li>
